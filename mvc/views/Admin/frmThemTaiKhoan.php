        ...
        <div class="container">
            <form METHOD="post">
                ...
                <div class="signup-link">
                    <a href="/CHVanPhongPham/Home/Show">Trở về</a>
                </div>
            </form>
        </div>
        <div>
...
<script>
    function submitForm() {
        $.ajax({
            url: "/VanPhongPham/mvc/controllers/Test_API/TaiKhoan/TestAPIPost.php", // Thay thế "process.php" bằng đường dẫn đến tệp PHP bạn muốn thực thi
            method: "POST",
            data: {
                action: "create",
                $ten: $_POST['ten'],
