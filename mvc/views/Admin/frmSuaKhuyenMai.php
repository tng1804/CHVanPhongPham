...
<form method="post">
    ...
    $mucGiam = "";
    $danhMucID = "";
    if (mysqli_num_rows($data["KM"]) > 0) {
        while ($row = mysqli_fetch_assoc($data["KM"])) {
            $tenKM = $row["tenKM"];
            $moTa = $row["moTa"];
            $ngayTao = $row["ngayTao"];
    ...
    <body class="bg-gradient-to-r from-blue-50 to-indigo-100 p-6">
        <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg transform transition duration-300 hover:shadow-2xl">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-indigo-600">Sửa thông tin khuyến mãi</h2>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="tenKM" value="<?php echo $tenKM ?>" class="mt-2 block w-full border border-gray-300 rounded-lg shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-800">Miêu tả</label>
                    <input type="text" name="moTa" value="<?php echo $moTa ?>" class="mt-2 block w-full border border-gray-300 rounded-lg shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-800">* Thời gian bắt đầu</label>
                    <div class="flex items-center space-x-4 mt-2">
                        <input type="date" name="ngayTao" value="<?php echo $ngayTao ?>" class="block w-full border border-gray-300 rounded-lg shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out">
                        ...
                        <input id="endDate" name="ngayKetThuc" value="<?php echo $ngayKetThuc ?>" type="date" class="block w-full border border-gray-300 rounded-lg shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out" value="---" disabled>
                    </div>
                </div>
                <div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <input type="number" id="discountInput" name="mucGiam" value="<?php echo $mucGiam ?>" class="block w-full border border-gray-300 rounded-lg shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out" value="0" oninput="updateDiscountVNĐ()">
                ...
                <div>
                    ...
                    <input type="number" id="conditionInput" name="dieuKien" value="<?php echo $dieuKien ?>" class="mt-2 block w-full border border-gray-300 rounded-lg shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out" disabled>
                </div>
                <div>
