...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item active"><a href="/VanPhongPham/KhachHang/AddKH"><b>Thêm khách hàng</b></a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <div class='row element-button'>
                        <div class='col-sm-2'>
                            <a class='btn btn-add btn-sm' href='/VanPhongPham/KhachHang/SearchKH' title='Tìm kiếm'><i class='fas fa-plus'></i>
                                Tìm kiếm khách hàng</a>
                            <br>
                            <br>
                            ...
                            <br>
                            <br>
                            <a class='btn btn-add btn-sm' href='/VanPhongPham/KhachHang/SortKH' title='Sắp xếp'><i class='fas fa-plus'></i>
                                Sắp xếp</a>
                        </div>
                    </div>
                    <div>
                        <h2>Tất cả các khách hàng:</h2>
                        ...
                        <table id="customers">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a name="submit" href="<?php echo '/VanPhongPham/KhachHang/UpdateKH/' . $row["id_khachhang"] . '' ?>" class="btn btn-delete" type="button" title="Sửa">
                                                <i class="fas fa-edit"></i></a>
                                            <a href="<?php echo '/VanPhongPham/KhachHang/DeleteKH/' . $row["id_khachhang"] . '' ?>" onclick="return confirm('Thông tin khách hàng sẽ bị xóa vĩnh viễn, bạn có chắc muốn tiếp tục không?');" class="btn btn-edit" type="button" title="Xóa"><i class="fas fa-trash"></i></a>
                                        </td>
