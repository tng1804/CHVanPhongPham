                ...
                echo"<table id='customers'>";
                    ...
                    <tbody>";
                        ...
                        while($row = mysqli_fetch_assoc($data["SP"])){
                            ...
                            echo "<td>
                            <a href='/VanPhongPham/SanPham/Delete/".$row["id_sanpham"]."' class='btn btn-delete' type='button' title='Xóa'>Xóa</a>
                            
                              <a href='/VanPhongPham/SanPham/Edit/".$row["id_sanpham"]."' class='btn btn-edit' type='button'  title='Sửa'>Sửa</a>     
                            </td>";
...
?> 
    ...
    <button>
        <a href = '/VanPhongPham/SanPham/Add'> Thêm Sản Phẩm </a>                
    </button>

    <button>
        <a href = '/VanPhongPham/SanPham/Search'> Tìm Kiếm</a>                
    </button>

    <button>
        <a href = '/VanPhongPham/SanPham/Sort'> Sắp Xếp</a>                
    </button>
